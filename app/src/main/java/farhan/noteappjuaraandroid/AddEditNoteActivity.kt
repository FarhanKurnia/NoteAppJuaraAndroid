...
class AddEditNoteActivity : AppCompatActivity() {
    companion object {
        const val EXTRA_ID = "farhan.noteappjuaraandroid.EXTRA_ID"
        const val EXTRA_JUDUL = "farhan.noteappjuaraandroid.EXTRA_JUDUL"
        const val EXTRA_DESKRIPSI = "farhan.noteappjuaraandroid.EXTRA_DESKRIPSI"
        const val EXTRA_PRIORITAS = "farhan.noteappjuaraandroid.EXTRA_PRIORITAS"
    }
